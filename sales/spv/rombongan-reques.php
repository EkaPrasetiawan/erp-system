...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                ...
                                res.forEach(item => {
                                    if(item.group_fasilitas && item.group_fasilitas.toLowerCase() === 'vendor'){
                                        ...
                                        `);
                                                ...
                                                item.group_fasilitas.toLowerCase() === 'operasional') && 
        ...
        <script>
            ...
            selecFasKet.addEventListener('change', function(){
                ...
                if(selectedFasKet){
                    ...
                    if(data){
                        unitKet.value = data.unit; // sesuaikan dengan nama field di DB
                    }
                } else {
                    unitKet.value = '';
                }
            ...
            $('#CatatanAdd').on('submit', function (e){
                ...
                const formData = $(this).serialize()+'&aksi=tambah_catatan';
            ...
            $('#CatatanUpdate').on('submit', function(e) {
                ...
                const formData = $(this).serialize()+'&aksi=update_catatan';
        ...
        <script>
            ...
            // tambah
            ['#qty', '#hargaWk', '#harga', '#hargaVend', '#jumlah', '#hargaFnB', '#qtyKet'].forEach(id => {
            ...
            // update
            ['#up_qty', '#up_hargaWk', '#up_harga', '#up_qtyV', '#up_hargaVend', '#up_jumlah', '#up_hargaFnB', '#up_qtyKet'].forEach(id => {
                $(document).on('input', id, function() {
                    setFormattedInput(this);
                });
            });
