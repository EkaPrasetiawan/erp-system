    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control input-angka" id="pax" name="pax"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control input-angka" id="harga" name="harga"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="tel" class="form-control input-angka" id="up_pax" name="up_pax"
                                        inputmode="numeric" maxlength="4" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="tel" class="form-control input-angka" id="upHarga" name="upHarga"
                                        inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
        ...
        <script>
            ...
            document.body.addEventListener('click', function(e){
                const clickedElement = e.target.closest('.btnPayment');
                if(clickedElement){
                    e.preventDefault();
        ...
        <script>
            ...
            document.addEventListener('input', function(e) {
                if (e.target.classList.contains('input-angka')) {
